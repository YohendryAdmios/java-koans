...
public class AboutEquality {
	...
	static class Car {
		...
		public boolean equals(Object other) {
			...
			if( (this.horsepower == comparableObject.horsepower) && (this.name == comparableObject.name) ) {
				return true;
			}
		...
		public int hashCode() {
			...
			return 37 * this.horsepower + this.name.hashCode();
		}
	}
	@Koan 
	...
	public void ownHashCodeImplementationPartTwo() {
		...
		// because return the same hashcode always
		// If it's valid why is this still not a good idea?
		// because the hash code must change
	}
